...
let
  ...
  cargoGitDependencies = {
    "git+https://github.com/dialog-db/dialog-db.git?branch=ucan-provider-caps#9cf8915f12047c765183725be1ad42016599523f" =
      "sha256-MyQRzVLpaSehtPOHhNoGHw+3qItQPmFypnoRPt/tbiM=";
