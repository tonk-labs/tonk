...
let
  ...
  cargoGitDependencies = {
    "git+https://github.com/dialog-db/dialog-db.git?branch=ucan-provider-caps#f630cc278dcde4f54890a7224edac7148070f98d" =
      "sha256-AWcT7T3wCoKh/ZaUw220LORKzl9VtG1D5wX3sCPsyOI=";
