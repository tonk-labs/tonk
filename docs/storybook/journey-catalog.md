...
| `UI-04` | Open a space home, explicit rendered route, or `/inspector`. | Blank/configured home; missing view/entity; local/remote; unauthorized; named-space/profile inspector. | Rendering/portal coverage, inspector renderer tests, and some E2E paths. | Top-level real-browser route matrix, configured-upstream probe, and interactive behavior beyond headless render. |
