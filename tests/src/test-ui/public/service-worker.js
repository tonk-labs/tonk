  ...
  H = function (t, e, r) {
    ...
    if (e && e.length > 0) {
      ...
      const s = document.querySelector('meta[property=csp-nonce]'),
        _ = s?.nonce || s?.getAttribute('nonce');
      o = Promise.allSettled(
        e.map(l => {
          if (((l = Pt(l)), l in lt)) return;
          lt[l] = !0;
          ...
          if (
            ((m.rel = E ? 'stylesheet' : Wt),
            E || (m.as = 'script'),
            (m.crossOrigin = ''),
            (m.href = l),
            _ && m.setAttribute('nonce', _),
    ...
    return o.then(s => {
      for (const _ of s || []) _.status === 'rejected' && a(_.reason);
      return t().catch(a);
    });
  };
var Bt = function (n, t, e, r, o) {
...
class O {
  constructor(t) {
    (T.set(this, void 0), Bt(this, T, t, 'f'));
  }
  static async fromBytes(t, e) {
    try {
      const { create_bundle_from_bytes: r } =
        e || (await H(() => Promise.resolve().then(() => Y), void 0));
      return new O(r(t));
    } catch (r) {
  ...
  async getRootId() {
    try {
      return await g(this, T, 'f').getRootId();
    } catch (t) {
  ...
  async get(t) {
    try {
      const e = await g(this, T, 'f').get(t);
  ...
  async getPrefix(t) {
    try {
      return (await g(this, T, 'f').getPrefix(t)).map(r => ({
        key: r.key,
        value: r.value,
      }));
    } catch (e) {
  ...
  async listKeys() {
    try {
      return await g(this, T, 'f').listKeys();
    } catch (t) {
  ...
  async getManifest() {
    try {
      return await g(this, T, 'f').getManifest();
    } catch (t) {
  ...
  async setManifest(t) {
    try {
      await g(this, T, 'f').setManifest(t);
    } catch (e) {
  ...
  async toBytes() {
    try {
      return await g(this, T, 'f').toBytes();
    } catch (t) {
...
class D {
  constructor(t) {
    (y.set(this, void 0), Bt(this, y, t, 'f'));
  }
  static async create(t, e) {
    const r = e || (await H(() => Promise.resolve().then(() => Y), void 0));
    if (t?.peerId && t?.storage) {
      const { create_tonk_with_config: o } = r,
        a = await o(t.peerId, t.storage.type === 'indexeddb');
      return new D(a);
    } else if (t?.peerId) {
      ...
      const { create_tonk_with_storage: o } = r,
        a = await o(t.storage.type === 'indexeddb');
      return new D(a);
    } else {
  ...
  static async fromBundle(t, e, r) {
    const o = r || (await H(() => Promise.resolve().then(() => Y), void 0));
    if (e?.storage) {
      const { create_tonk_from_bundle_with_storage: a } = o,
        s = await a(t, e.storage.type === 'indexeddb');
      return new D(s);
    } else {
      const { create_tonk_from_bundle: a } = o,
        s = await a(t);
      return new D(s);
    }
  }
  static async fromBytes(t, e, r) {
    const o = r || (await H(() => Promise.resolve().then(() => Y), void 0));
    if (e?.storage) {
      const { create_tonk_from_bytes_with_storage: a } = o,
        s = await a(t, e.storage.type === 'indexeddb');
      return new D(s);
    } else {
      const { create_tonk_from_bytes: a } = o,
        s = await a(t);
      return new D(s);
    }
  }
  getPeerId() {
    return g(this, y, 'f').getPeerId();
  }
  async connectWebsocket(t) {
    try {
      await g(this, y, 'f').connectWebsocket(t);
    } catch (e) {
      throw new vt(`Failed to connect to ${t}: ${e}`);
    }
  }
  async forkToBytes(t) {
    try {
      return await g(this, y, 'f').forkToBytes(t);
    } catch (e) {
  ...
  async toBytes(t) {
    try {
      return await g(this, y, 'f').toBytes(t);
    } catch (e) {
      throw new Q(`Failed to serialize to bundle data: ${e}`);
    }
  }
  async createFile(t, e) {
    try {
      await g(this, y, 'f').createFile(t, e);
    } catch (r) {
      throw new h(`Failed to create file at ${t}: ${r}`);
    }
  }
  async createFileWithBytes(t, e, r) {
    try {
      let o = typeof r == 'string' ? ft(r) : r;
      await g(this, y, 'f').createFileWithBytes(t, e, o);
    } catch (o) {
      throw new h(`Failed to create file at ${t}: ${o}`);
    }
  }
  async readFile(t) {
    try {
      const e = await g(this, y, 'f').readFile(t);
      if (e === null) throw new h(`File not found: ${t}`);
      let r;
      return (
        e.bytes && (r = ut(e.bytes)),
        { ...e, content: JSON.parse(e.content), bytes: r }
      );
    } catch (e) {
      throw e instanceof h ? e : new h(`Failed to read file at ${t}: ${e}`);
    }
  }
  async updateFile(t, e) {
    try {
      return await g(this, y, 'f').updateFile(t, e);
    } catch (r) {
      throw new h(`Failed to update file at ${t}: ${r}`);
    }
  }
  async updateFileWithBytes(t, e, r) {
    try {
      let o = typeof r == 'string' ? ft(r) : r;
      return await g(this, y, 'f').updateFileWithBytes(t, e, o);
    } catch (o) {
      throw new h(`Failed to update file at ${t}: ${o}`);
    }
  }
  async deleteFile(t) {
    try {
      return await g(this, y, 'f').deleteFile(t);
    } catch (e) {
      throw new h(`Failed to delete file at ${t}: ${e}`);
    }
  }
  async createDirectory(t) {
    try {
      await g(this, y, 'f').createDirectory(t);
    } catch (e) {
      throw new h(`Failed to create directory at ${t}: ${e}`);
    }
  }
  async listDirectory(t) {
    try {
      return (await g(this, y, 'f').listDirectory(t)).map(r => ({
        name: r.name,
        type: r.type,
      ...
      throw new h(`Failed to list directory at ${t}: ${e}`);
    }
  }
  async exists(t) {
    try {
      return await g(this, y, 'f').exists(t);
    } catch (e) {
      throw new h(`Failed to check existence of ${t}: ${e}`);
    }
  }
  async rename(t, e) {
    try {
      return await g(this, y, 'f').rename(t, e);
    } catch (r) {
      throw new h(`Failed to rename ${t} to ${e}: ${r}`);
    }
  }
  async getMetadata(t) {
    try {
      const e = await g(this, y, 'f').getMetadata(t);
      if (e === null) throw new h(`File or directory not found: ${t}`);
      return e;
    } catch (e) {
      throw e instanceof h ? e : new h(`Failed to get metadata for ${t}: ${e}`);
    }
  }
  async watchFile(t, e) {
    try {
      const r = await g(this, y, 'f').watchDocument(t, o => {
        let a;
        (o.bytes && (a = ut(o.bytes)),
          e({ ...o, content: JSON.parse(o.content), bytes: a }));
      });
      if (r === null) throw new h(`File not found: ${t}`);
      return r;
    } catch (r) {
      throw r instanceof h
        ? r
        : new h(`Failed to watch file at path ${t}: ${r}`);
    }
  }
  async watchDirectory(t, e) {
    try {
      const r = await g(this, y, 'f').watchDirectory(t, e);
      if (r === null) throw new h(`Directory not found: ${t}`);
      return r;
    } catch (r) {
      throw r instanceof h
        ? r
        : new h(`Failed to watch directory at path ${t}: ${r}`);
    }
  }
  free() {
    g(this, y, 'f').free();
...
const ft = n => {
  ...
  ut = n => {
    ...
    if (Array.isArray(n)) {
      ...
      return btoa(e);
    } else throw new h(`Unrecognized bytes type in readFile ${typeof n}`);
  };
let i,
  J = null;
function C() {
  return (
    (J === null || J.byteLength === 0) && (J = new Uint8Array(i.memory.buffer)),
    J
  );
}
...
function w(n, t, e) {
  ...
  let s = 0;
  for (; s < r; s++) {
    const _ = n.charCodeAt(s);
    if (_ > 127) break;
    a[o + s] = _;
  }
  if (s !== r) {
    (s !== 0 && (n = n.slice(s)),
      (o = e(o, r, (r = s + n.length * 3), 1) >>> 0));
    const _ = C().subarray(o + s, o + r),
      l = X.encodeInto(n, _);
    ((s += l.written), (o = e(o, r, s, 1) >>> 0));
  }
  return ((u = s), o);
}
let $ = null;
function k() {
  return (
    ($ === null ||
      $.buffer.detached === !0 ||
      ($.buffer.detached === void 0 && $.buffer !== i.memory.buffer)) &&
      ($ = new DataView(i.memory.buffer)),
    $
  );
}
function P(n) {
  ...
  const o = { a: n, b: t, cnt: 1, dtor: e },
    a = (...s) => {
      ...
      try {
        ...
        --o.cnt === 0
          ? (i.__wbindgen_export_6.get(o.dtor)(_, o.b), dt.unregister(o))
          : (o.a = _);
      }
    };
  return ((a.original = o), dt.register(a, o, o), a);
}
function U(n) {
...
function wt(n, t) {
  ...
  return (C().set(n, e / 1), (u = n.length), e);
}
function zt(n) {
  return (_t(n, v), i.create_tonk_from_bundle(n.__wbg_ptr));
}
function $t(n, t) {
  return (_t(n, v), i.create_tonk_from_bundle_with_storage(n.__wbg_ptr, t));
}
function Ot(n, t) {
...
const Qt = ['blob', 'arraybuffer'],
  Zt = ['pending', 'done'],
  te = ['readonly', 'readwrite', 'versionchange', 'readwriteflush', 'cleanup'],
  bt =
    typeof FinalizationRegistry > 'u'
      ? { register: () => {}, unregister: () => {} }
...
class q {
  ...
  static fromBundle(t) {
    return (_t(t, v), i.wasmtonkcore_fromBundle(t.__wbg_ptr));
  }
  getPeerId() {
  ...
  createFileWithBytes(t, e, r) {
    const o = w(t, i.__wbindgen_malloc, i.__wbindgen_realloc),
      a = u,
      s = wt(r, i.__wbindgen_malloc),
      _ = u;
    return i.wasmtonkcore_createFileWithBytes(this.__wbg_ptr, o, a, e, s, _);
  }
  updateFileWithBytes(t, e, r) {
    const o = w(t, i.__wbindgen_malloc, i.__wbindgen_realloc),
      ...
      s = wt(r, i.__wbindgen_malloc),
      _ = u;
    return i.wasmtonkcore_updateFileWithBytes(this.__wbg_ptr, o, a, e, s, _);
  }
  constructor() {
  ...
  rename(t, e) {
    const r = w(t, i.__wbindgen_malloc, i.__wbindgen_realloc),
      o = u,
      a = w(e, i.__wbindgen_malloc, i.__wbindgen_realloc),
      s = u;
    return i.wasmtonkcore_rename(this.__wbg_ptr, r, o, a, s);
  }
  toBytes(t) {
  ...
  return (
    ...
    (n.wbg.__wbg_String_8f0eb39a4a4c2f66 = function (t, e) {
      const r = String(e),
        ...
        a = u;
      (k().setInt32(t + 4 * 1, a, !0), k().setInt32(t + 4 * 0, o, !0));
    }),
    ...
    (n.wbg.__wbg_createObjectStore_2bc52da689ca2130 = function () {
      return d(function (t, e, r) {
        return t.createObjectStore(b(e, r));
      }, arguments);
    }),
    ...
    (n.wbg.__wbg_item_dc4321784299a463 = function (t, e, r) {
      const o = e.item(r >>> 0);
      var a = B(o) ? 0 : w(o, i.__wbindgen_malloc, i.__wbindgen_realloc),
        s = u;
      (k().setInt32(t + 4 * 1, s, !0), k().setInt32(t + 4 * 0, a, !0));
    }),
    ...
    (n.wbg.__wbg_log_0cc1b7768397bcfe = function (t, e, r, o, a, s, _, l) {
      let E, S;
      try {
        ((E = t), (S = e), console.log(b(t, e), b(r, o), b(a, s), b(_, l)));
      } finally {
        i.__wbindgen_free(E, S, 1);
      }
    }),
      ...
      return d(function (t, e, r, o) {
        ...
        try {
          ((a = t),
            ...
            (_ = r),
            (l = o),
            performance.measure(b(t, e), b(r, o)));
        } finally {
          (i.__wbindgen_free(a, s, 1), i.__wbindgen_free(_, l, 1));
        }
      }, arguments);
    }),
    ...
    (n.wbg.__wbg_open_7281831ed8ff7bd2 = function () {
      return d(function (t, e, r, o) {
        return t.open(b(e, r), o >>> 0);
      }, arguments);
    }),
    (n.wbg.__wbg_prototypesetcall_3d4a26c1ed734349 = function (t, e, r) {
      Uint8Array.prototype.set.call(K(t, e), r);
    }),
    ...
    (n.wbg.__wbg_transaction_553a104dd139f032 = function () {
      return d(function (t, e, r, o) {
        return t.transaction(b(e, r), te[o]);
      }, arguments);
    }),
...
async function tt(n) {
  ...
  (typeof n < 'u' &&
    ...
    typeof n > 'u' &&
      (n = new URL('/assets/tonk_core_bg-DBKNCULl.wasm', import.meta.url)));
  const t = It();
  (typeof n == 'string' ||
    (typeof Request == 'function' && n instanceof Request) ||
    (typeof URL == 'function' && n instanceof URL)) &&
    (n = fetch(n));
  const { instance: e, module: r } = await ne(await n, t);
  return Rt(e, r);
}
  ...
  Object.defineProperty(
    {
      ...
      WasmBundle: v,
      WasmDocHandle: M,
      WasmDocumentWatcher: L,
      WasmError: j,
      WasmRepo: N,
      WasmTonkCore: q,
      WasmWebSocketHandle: V,
      create_bundle_from_bytes: Mt,
      create_tonk: Lt,
      create_tonk_from_bundle: zt,
      create_tonk_from_bundle_with_storage: $t,
      create_tonk_from_bytes: Ct,
      create_tonk_from_bytes_with_storage: Nt,
      create_tonk_with_config: Ot,
      create_tonk_with_peer_id: qt,
      create_tonk_with_storage: Vt,
      default: tt,
      init: jt,
      initSync: re,
      set_time_provider: Kt,
    },
    Symbol.toStringTag,
    { value: 'Module' }
  )
...
async function it(n) {
  if (!St)
    return (
      ...
      ((G = (async () => {
        try {
          (n?.wasmPath ? await tt(n.wasmPath) : await tt(), (St = !0));
        } catch (t) {
          throw ((G = null), t);
        }
      })()),
...
console.log('🔍 DEBUG_LOGGING enabled:', Dt);
console.log('🌐 Service worker location:', self.location.href);
console.log('UNIQUE ID:', 779);
let p = { status: 'uninitialized' },
  F = null;
function A() {
  return p.status === 'ready' ? p : null;
}
const et = 'tonk-sw-state-v1',
  ct = '/tonk-state/appSlug',
  at = '/tonk-state/bundleBytes';
async function Tt(n) {
  try {
    const t = await caches.open(et);
    if (n === null) await t.delete(ct);
    else {
      const e = new Response(JSON.stringify({ slug: n }), {
        headers: { 'Content-Type': 'application/json' },
      });
      await t.put(ct, e);
    }
    c('info', 'AppSlug persisted to cache', { slug: n });
  } catch (t) {
    c('error', 'Failed to persist appSlug', {
...
async function oe() {
  try {
    const t = await (await caches.open(et)).match(ct);
    return (t && (await t.json()).slug) || null;
  } catch (n) {
    return (
      c('error', 'Failed to restore appSlug', {
...
async function st(n) {
  try {
    const t = await caches.open(et);
    if (n === null) await t.delete(at);
    else {
      const e = new Blob([n], { type: 'application/octet-stream' }),
        r = new Response(e, {
          headers: { 'Content-Type': 'application/octet-stream' },
        });
      await t.put(at, r);
    }
    c('info', 'Bundle bytes persisted to cache', { size: n ? n.length : 0 });
  } catch (t) {
    c('error', 'Failed to persist bundle bytes', {
      error: t instanceof Error ? t.message : String(t),
    });
  }
}
async function ie() {
  try {
    const t = await (await caches.open(et)).match(at);
    if (!t) return null;
    const e = await t.arrayBuffer();
    return new Uint8Array(e);
  } catch (n) {
    return (
      c('error', 'Failed to restore bundle bytes', {
        error: n instanceof Error ? n.message : String(n),
      }),
      null
    );
...
c('info', 'Service worker starting, checking for cached state');
...
async function ce() {
  try {
    const n = await oe(),
      t = await ie();
    if (!n || !t) {
      (c('info', 'No cached state found, waiting for initialization message', {
        hasSlug: !!n,
        hasBundle: !!t,
      }),
    ...
    ((F = n),
      c('info', 'Found cached state, auto-initializing', {
        slug: F,
        bundleSize: t.length,
      }),
      console.log('🔄 SERVICE WORKER: Auto-initializing from cache...', F));
    const e = 'http://localhost/tonk_core_bg.wasm';
    (c('info', 'Fetching WASM from server'),
      await it({ wasmPath: e }),
      c('info', 'WASM initialization completed'));
    const o = await (await O.fromBytes(t)).getManifest();
    c('info', 'Bundle and manifest restored from cache');
    const a = await D.fromBytes(t);
    c('info', 'TonkCore created from cached bundle');
    const s = 'http://localhost'.replace(/^http/, 'ws');
    (await a.connectWebsocket(s), c('info', 'Websocket connected'));
    let _ = 0;
    const l = 20;
    for (; _ < l; )
      try {
        (await a.listDirectory('/app'),
          c('info', 'Auto-initialization complete - tonk ready'),
          console.log('✅ SERVICE WORKER: Auto-initialized successfully'));
        break;
      } catch {
        (_++,
          _ >= l
            ? c('warn', 'Initial sync timeout after restore', { attempts: _ })
            : await new Promise(S => setTimeout(S, 500)));
      }
    p = { status: 'ready', tonk: a, manifest: o };
  } catch (n) {
    (c('error', 'Auto-initialization failed', {
      error: n instanceof Error ? n.message : String(n),
    }),
      console.error('❌ SERVICE WORKER: Auto-initialization failed:', n),
      (p = { status: 'uninitialized' }),
      (F = null),
      (await self.clients.matchAll()).forEach(e => {
        e.postMessage({
...
const Ft = async (n, t) => {
  ...
  Et = n => {
    ...
    if (
      ...
      const s = `${F}/index.html`;
      return (
        console.log('determinePath - defaulting to index.html', { result: s }),
        s
      );
    }
    const a = `${F}/${o.join('/')}`;
    return (
      console.log('determinePath - returning file path', { result: a }),
      a
    );
  };
self.addEventListener('fetch', n => {
  ...
  (console.log(
    ...
    console.log('🔥 Tonk state:', p.status),
    console.log('🔥 Current appSlug:', F),
  ...
  (r &&
    F &&
    ((F = null),
    Promise.all([Tt(null), st(null)]).catch(o => {
      c('error', 'Failed to persist state reset', { error: o });
    })),
    F && t.origin === location.origin && !r
        ...
        n.respondWith(
          (async () => {
            try {
              ...
              const s = `/app/${o}`;
              if (!(await a.tonk.exists(s))) {
                (console.warn(
                  `🚨 File not found: ${s}, falling back to index.html`
                ),
                  c('warn', 'File not found, falling back to index.html', {
                    requestedPath: s,
                    fallbackPath: `/app/${F}/index.html`,
                  }));
                const S = `/app/${F}/index.html`,
                  m = await a.tonk.readFile(S);
                return (
              ...
              const l = await a.tonk.readFile(s);
              c('info', 'Successfully read file from Tonk', {
                filePath: s,
                hasContent: !!l.content,
                hasBytes: !!l.bytes,
                contentType: l.content ? l.content.mime : 'unknown',
              });
              const E = Ft(l, o);
              return (
                c('info', 'Created response for file', {
                  filePath: `/app/${o}`,
                  responseType: l.bytes ? 'binary' : 'text',
                }),
                E
              );
            } catch (o) {
...
async function ae(n) {
  if (
    ...
    ((F = n.slug),
      await Tt(F),
      c('info', 'App slug set and persisted', { slug: F }));
    return;
  }
  const t = ['init', 'loadBundle', 'initializeFromUrl', 'getServerUrl'];
  if (p.status !== 'ready' && !t.includes(n.type)) {
  ...
  switch (n.type) {
      ...
      try {
        if (p.status === 'ready') {
          (c('info', 'Tonk already initialized, responding with success'),
            f({ type: 'init', success: !0 }));
          return;
        }
        if (p.status === 'loading') {
          c('info', 'Tonk is loading, waiting for completion');
          try {
            const { tonk: e, manifest: r } = await p.promise;
        ...
        if (p.status === 'failed') {
          (c('error', 'Tonk initialization failed previously', {
            ...
            f({ type: 'init', success: !1, error: p.error.message }));
          return;
        }
        (c('warn', 'Tonk is uninitialized, this is unexpected'),
          f({ type: 'init', success: !1, error: 'Tonk not initialized' }));
      } catch (e) {
    ...
    case 'readFile':
      ...
      try {
        ...
        (c('info', 'File read successfully', {
          ...
          f({ type: 'readFile', id: n.id, success: !0, data: r }));
      } catch (e) {
    ...
    case 'writeFile':
      ...
      try {
        ...
        (n.create
          ...
          f({ type: 'writeFile', id: n.id, success: !0 }));
      } catch (e) {
    ...
    case 'deleteFile':
      ...
      try {
        ...
        (await e.deleteFile(n.path),
          ...
          f({ type: 'deleteFile', id: n.id, success: !0 }));
      } catch (e) {
    ...
    case 'rename':
      ...
      try {
        ...
        (await e.rename(n.oldPath, n.newPath),
          ...
          f({ type: 'rename', id: n.id, success: !0 }));
      } catch (e) {
    ...
    case 'listDirectory':
      ...
      try {
        ...
        (c('info', 'Directory listed successfully', {
          ...
          f({ type: 'listDirectory', id: n.id, success: !0, data: r }));
      } catch (e) {
    ...
    case 'exists':
      ...
      try {
        ...
        (c('info', 'File existence check completed', {
          ...
          f({ type: 'exists', id: n.id, success: !0, data: r }));
      } catch (e) {
        ...
        const { tonk: e } = A(),
          r = await e.watchFile(n.path, o => {
            (c('info', 'File change detected', {
              ...
              f({ type: 'fileChanged', watchId: n.id, documentData: o }));
          });
        (W.set(n.id, r),
          c('info', 'File watch started successfully', {
            path: n.path,
            watchId: n.id,
            totalWatchers: W.size,
          }),
          f({ type: 'watchFile', id: n.id, success: !0 }));
      } catch (e) {
        ...
        (e
          ? (c('info', 'Found watcher, stopping it', { watchId: n.id }),
            ...
            c('info', 'File watch stopped successfully', {
              watchId: n.id,
              remainingWatchers: W.size,
            }))
          : c('warn', 'No watcher found for ID', { watchId: n.id }),
          f({ type: 'unwatchFile', id: n.id, success: !0 }));
      } catch (e) {
    ...
    case 'watchDirectory':
      ...
      try {
        ...
        (W.set(n.id, r),
          ...
          f({ type: 'watchDirectory', id: n.id, success: !0 }));
      } catch (e) {
    ...
    case 'unwatchDirectory':
      ...
      try {
        ...
        (e
          ...
          f({ type: 'unwatchDirectory', id: n.id, success: !0 }));
      } catch (e) {
    ...
    case 'toBytes':
      ...
      try {
        ...
        (c('info', 'Tonk converted to bytes successfully', {
          ...
          f({ type: 'toBytes', id: n.id, success: !0, data: o, rootId: a }));
      } catch (e) {
    ...
    case 'forkToBytes':
      ...
      try {
        const { tonk: e } = A(),
          ...
          a = await (await O.fromBytes(r)).getManifest(),
          s = a.rootId;
        (c('info', 'Tonk forked to bytes successfully', {
          id: n.id,
          byteLength: r.length,
          rootId: s,
          manifestKeys: Object.keys(a),
        }),
          f({
            type: 'forkToBytes',
            id: n.id,
    ...
    case 'loadBundle':
      ...
      try {
        const e = n.serverUrl || 'http://localhost';
        if (
          (c('info', 'Using server URL', { serverUrl: e }),
          p.status === 'uninitialized')
        ) {
          c('info', 'WASM not initialized, initializing now');
          const R = `${`${e}/tonk_core_bg.wasm`}?t=${Date.now()}`;
          (c('info', 'Fetching WASM from', { cacheBustUrl: R }),
            await it({ wasmPath: R }),
            c('info', 'WASM initialization completed for bundle loading'));
        }
        const r = new Uint8Array(n.bundleBytes);
        c('info', 'Creating bundle from bytes', { byteLength: r.length });
        const a = await (await O.fromBytes(r)).getManifest();
        (c('info', 'Bundle and manifest created successfully'),
          c('info', 'Creating new TonkCore from bundle bytes'));
        const s = await D.fromBytes(r);
        c('info', 'New TonkCore created successfully');
        const l = new URLSearchParams(self.location.search).get('bundle');
        let E = e.replace(/^http/, 'ws');
        if (l)
          try {
            const I = atob(l),
              R = JSON.parse(I);
        ...
        (c('info', 'Determined websocket URL', { wsUrl: E, serverUrl: e }),
          c('info', 'Connecting new tonk to websocket', { wsUrl: E }),
          await s.connectWebsocket(E),
        ...
        ((p = { status: 'ready', tonk: s, manifest: a }),
          c('info', 'Tonk state updated with new instance'),
          await st(r),
          c('info', 'Bundle bytes persisted to IndexedDB'),
          f({ type: 'loadBundle', id: n.id, success: !0 }));
      } catch (e) {
    ...
    case 'initializeFromUrl':
      ...
      try {
        const e = n.wasmUrl || 'http://localhost/tonk_core_bg.wasm',
          r = n.manifestUrl || 'http://localhost/.manifest.tonk',
          o = n.wsUrl || 'http://localhost'.replace(/^http/, 'ws');
        c('info', 'Fetching WASM from URL', { wasmUrl: e });
        const a = `${e}?t=${Date.now()}`;
        (await it({ wasmPath: a }),
          c('info', 'WASM initialization completed'),
        ...
        const E = await (await O.fromBytes(_)).getManifest();
        (c('info', 'Bundle and manifest created successfully'),
          c('info', 'Creating TonkCore from manifest bytes'));
        const S = await D.fromBytes(_);
        ...
        ((p = { status: 'ready', tonk: S, manifest: E }),
          c('info', 'Tonk state updated to ready from URL'),
          await st(_),
          c('info', 'Bundle bytes persisted to IndexedDB'),
          f({ type: 'initializeFromUrl', id: n.id, success: !0 }));
      } catch (e) {
...
c('info', 'VFS Service Worker started', { debugLogging: Dt });
