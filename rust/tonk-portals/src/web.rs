...
/// Inject the `<tonk-portals>` JS module into `<head>` exactly once.
///
...
/// pass `/tonk-portals/tonk-portals.js` if you've used the matching
/// `copy-dir` link in `index.html`.
...
const SCRIPT_ID: &str = "tonk-portals-loader";
