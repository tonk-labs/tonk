...
fn profile_commands() -> CommandRegistry<CommandEnv> {
    CommandRegistry::new()
        ...
        .command::<tonk_schema::command::SaveEncryptionKey>()
        .command::<tonk_schema::command::RefreshConnections>()
        .command::<tonk_schema::command::RevokeConnection>()
        .command::<tonk_schema::command::DescribeLocalSpaceLink>()
