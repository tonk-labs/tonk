...
//! [`tonk_render::page`]; this module is just the slide-side wiring:
//! it implements [`tonk_render::QueryBackend`] over a [`SlideSite`]'s
...
pub async fn render(site: &SlideSite, route: &RenderRoute) -> Result<String, RenderError> {
