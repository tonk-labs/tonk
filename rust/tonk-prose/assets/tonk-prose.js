var b=16n,y=(1n<<b)-1n;function w(e,t){return BigInt(e)<<b|BigInt(t)&y}function p(e){return Number(e>>b)}function a(e){return Number(e&y)}var u=class{#e=0n;#o;constructor(t=()=>Date.now()){this.#o=t}get last(){return this.#e}tick(){let t=this.#o(),o=p(this.#e),r=Math.max(o,t),i=r===o?a(this.#e)+1:0;return this.#e=w(r,i),this.#e}receive(t){let o=this.#o(),r=p(this.#e),i=p(t),s=Math.max(r,i,o),n;return s===r&&s===i?n=Math.max(a(this.#e),a(t))+1:s===r?n=a(this.#e)+1:s===i?n=a(t)+1:n=0,this.#e=w(s,n),this.#e}};function E(e){let t=e.trim();if(!/^\d+$/.test(t))return null;try{return BigInt(t)}catch{return null}}function h(e){return e.toString()}var m="Tonk-Prose-Version",C="1";function x(e){return e.slice(0,m.length+1).toLowerCase()===`${m.toLowerCase()}:`}function d(e){if(!x(e))return{hlc:null,value:e};let t=e.indexOf(`\r
\r
`),o=e.indexOf(`

`),r,i;if(t!==-1&&(o===-1||t<=o))r=t,i=t+4;else if(o!==-1)r=o,i=o+2;else return{hlc:null,value:e};let s=e.slice(i),n=e.slice(0,r).split(/\r\n|\n/),c=null;for(let f of n){let g=f.indexOf(":");if(g===-1)continue;f.slice(0,g).trim().toLowerCase()==="etag"&&(c=E(f.slice(g+1).trim().replace(/^"|"$/g,"")))}return{hlc:c,value:s}}function v(e){return e.hlc===null?e.value:`${m}: ${C}\r
ETag: "${h(e.hlc)}"\r
Content-Type: text/markdown\r
\r
`+e.value}var O=["content","value","readonly","placeholder","auto-focus","switcher"],A=400;async function M(){let e=globalThis.__tonkProseEditor;if(typeof e=="string"&&e)return e;if(typeof e=="function"){let t=await e();if(typeof t=="string"&&t)return t}return new URL("./tonk-prose-editor.js",import.meta.url).href}var l=null;function S(){return l||(l=M().then(e=>import(e).then(t=>t)),l.catch(()=>{l=null})),l}var k=class extends HTMLElement{static get observedAttributes(){return O}#e;#o;candidates=[];#t=null;#c=0;#i=null;#s=null;#n=null;#u=null;#h=new u;#r=0n;#a=!1;constructor(){super(),this.#e=this.attachShadow({mode:"open",delegatesFocus:!0});let t=document.createElement("style");t.textContent=T,this.#o=document.createElement("div"),this.#o.className="mount",this.#e.append(t,this.#o)}connectedCallback(){if(this.#a=!1,this.#s||(this.#s=new MutationObserver(()=>this.#p()),this.#s.observe(this,{childList:!0,characterData:!0,subtree:!0})),this.#t)return;let t=++this.#c;this.#b(t)}#d(){return this.textContent??""}#p(){this.#l(this.#d())}async#b(t){let o;try{o=await S()}catch(n){console.warn("[tonk-prose] failed to load editor core:",n);return}if(t!==this.#c||!this.isConnected)return;let r=this.#i;if(r===null){let n=this.#d();r=n!==""?n:this.getAttribute("content")??this.getAttribute("value")}let i="";if(r!==null){let n=d(r);i=n.value,n.hlc!==null&&n.hlc>this.#r&&(this.#r=this.#h.receive(n.hlc))}let s=o.createEditor(this.#o,{doc:i,readOnly:this.hasAttribute("readonly"),placeholder:this.getAttribute("placeholder")??"",onChange:n=>{this.#m(n)},switcher:this.hasAttribute("switcher")?{candidates:()=>this.candidates,onOpen:n=>this.#f("switch",n),onCreate:n=>this.#f("create",{title:n,document:this.value}),onSuggest:(n,c)=>this.#f("suggest",{rows:n,active:c})}:void 0});this.#i=null,this.#t=s,this.dispatchEvent(new CustomEvent("ready",{detail:{editor:s},bubbles:!0,composed:!0})),!this.hasAttribute("readonly")&&this.hasAttribute("auto-focus")&&setTimeout(()=>{if(this.#t===s){try{window.focus()}catch{}s.focus()}},0)}#f(t,o){this.dispatchEvent(new CustomEvent(t,{detail:o,bubbles:!0,composed:!0}))}#m(t){this.#u=t,this.#n!==null&&clearTimeout(this.#n),this.#n=setTimeout(()=>this.#g(),A)}#g(){this.#n=null;let t=this.#u;if(this.#u=null,t===null)return;let o=this.#h.tick();this.#r=o;let r=v({hlc:o,value:t});this.dispatchEvent(new CustomEvent("change",{detail:{value:t,content:r},bubbles:!0,composed:!0}))}disconnectedCallback(){this.#a||(this.#a=!0,setTimeout(()=>{this.#a&&(this.#a=!1,!this.isConnected&&(this.#n!==null&&(clearTimeout(this.#n),this.#g()),this.#s?.disconnect(),this.#s=null,this.#c++,this.#t?.destroy(),this.#t=null))},0))}attributeChangedCallback(t,o,r){switch(t){case"content":this.#l(r??"");break;case"value":(r??"")!==this.value&&this.#l(r??"");break;case"readonly":this.#t?.setReadOnly(r!==null);break;case"placeholder":this.#t?.setPlaceholder(r??"");break;case"auto-focus":break}}#l(t){let{hlc:o,value:r}=d(t);if(o!==null){if(o<=this.#r)return;this.#r=this.#h.receive(o)}if(!this.#t){this.#i=r;return}this.#t.setMarkdown(r)}get value(){if(this.#t)return this.#t.getMarkdown();if(this.#i!==null)return this.#i;let t=this.#d(),o=t!==""?t:this.getAttribute("content")??this.getAttribute("value");return o===null?"":d(o).value}set value(t){this.#l(t)}get content(){return v({hlc:this.#r,value:this.value})}set content(t){this.#l(t)}get version(){return h(this.#r)}focus(){this.#t?this.#t.focus():super.focus()}get editor(){return this.#t}},T=`
  :host {
