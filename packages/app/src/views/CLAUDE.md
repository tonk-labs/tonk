# DO NOT EDIT - AUTO-GENERATED FROM docs/src/llms/shared/views.md

# This file is automatically generated from the documentation.

# Edit the source file instead: docs/src/llms/shared/views.md

#

# Generated on: 2025-07-22T12:58:35.180Z
...
- Always use semantic HTML elements (e.g., `main`, `section`, `article`, `nav`) for better
  accessibility
...
export const ProfileSettings: React.FC<ProfileSettingsProps> = ({ userId, isEditable = true }) => {
