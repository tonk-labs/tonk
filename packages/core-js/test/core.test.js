...
describe('TonkCore', () => {
  ...
  test('should create and read a simple text file', async () => {
    ...
    assert.strictEqual(retrieved.content.sampleString, sampleString);
  ...
  test('should read and write bytes', async () => {
    ...
    assert.equal(retrieved.content.mime, 'image/png');
  ...
  test('Bundle.forkToBytes should create a new fork with same contents', async () => {
    ...
    assert.strictEqual(img.content.mime, 'image/png');
