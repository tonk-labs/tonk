...
const createWindow = async () => {
  ...
  if (!tonkServerStarted) {
    console.warn('Tonk sync server failed to start, continuing with browser only...');
  }
...
ipcMain.handle('open-file-dialog', async () => {
  const result = await dialog.showOpenDialog({
    ...
    filters: [
      ...
      { name: 'Text Files', extensions: ['txt', 'md', 'json', 'js', 'ts', 'jsx', 'tsx'] },
