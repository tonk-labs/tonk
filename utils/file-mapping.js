...
const SOURCE_MAPPINGS = {
	...
	"docs/src/llms/shared/instructions.md": {
		...
		exclude: [
			"packages/create/templates/worker", // Workers have their own instructions
			"packages/create/templates/workspace", // Workspace has its own specific content
		],
	},
	...
	"docs/src/llms/shared/views.md": {
		contentTypes: ["views"],
		exclude: ["packages/create/templates/workspace"], // Workspace has its own views content
	},
	...
	"docs/src/llms/shared/keepsync/react-browser.md": {
		...
		exclude: ["packages/create/templates/worker"],
	},
	...
	"docs/src/llms/templates/worker/README.md": {
		...
		include: ["packages/create/templates/worker"],
	},
	// Workspace-specific
	"docs/src/llms/templates/workspace/views.md": {
		contentTypes: ["views"],
		include: ["packages/create/templates/workspace"],
	},
	"docs/src/llms/templates/workspace/README.md": {
		contentTypes: ["root"],
		include: ["packages/create/templates/workspace"], // Workspace-specific root content
	},
	"docs/src/llms/templates/workspace/instructions.md": {
		contentTypes: ["instructions"],
		include: ["packages/create/templates/workspace"], // Workspace-specific instructions
	},
